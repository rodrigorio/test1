 ...
 */
class ParametroControlador extends Parametro
{
    private $sValor;

    /**
     * Seria el id de controlador de la tabla NxN que relaciona parametros con controladores.
     */
    private $iGrupoId;

    /**
     * El string que distingue la entidad a la que esta asociado el parametro
     * (el nombre del modulo_controlador)
     */
    private $sGrupo;
