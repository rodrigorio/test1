...
class FrontController
{
    ...
    public function setResponse($response)
    {
        if (!$response instanceof Exception){      
            throw new Exception('Response debe ser un Exception');
        }
	...
	$request = new HttpRequest();
        ...
        /**
         * Register request with plugin broker
         */
        $this->plugins->setRequest($this->request);
		...
		$this->setResponse($e); //Si no se esta testeando, la excepcion se almacena en lugar de throw para realizar redirect.
            }
