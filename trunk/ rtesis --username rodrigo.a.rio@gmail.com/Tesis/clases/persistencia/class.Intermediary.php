...
abstract class Intermediary
{
	 ...
	 * @param DB $conn;
	 */
	function &getInstance(IMYSQL $conn);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    protected final function crearCondicionSimple($filtro, $aliasTabla = ""){}
