<?php
/**
 * Description of class NivelMySQLIntermediary
 *
 * @author Andres
 */
class NivelMySQLIntermediary extends NivelIntermediary
{
	...
	public final function obtener($filtro, &$iRecordsTotal, $sOrderBy = null, $sOrder = null, $iIniLimit = null, $iRecordCount = null){
		try{
            ...
            $sSQL = "SELECT SQL_CALC_FOUND_ROWS
                        n.id as iId, n.descripcion as sDescripcion
                    FROM
                       niveles n ";
                    if(!empty($filtro)){     
	...
	public  function insertar($oNivel)
		...
		try{
			...
			$sSQL =	" insert into niveles ".
                    " set descripcion =".$db->escape($oNivel->getDescripcion(),true)." ";
	...
	public  function actualizar($oNivel)
   	{
		try{
			...
			$sSQL =	" update niveles ".
                    " set descripcion =".$db->escape($oNivel->getDescripcion(),true)." " .
                    " where id =".$db->escape($oNivel->getId(),false,MYSQL_TYPE_INT)." ";
    ...
    public function guardar($oNivel)
    {
 	...
 	public function borrar($oNivel) {
		try{
			$db = $this->conn;
			$db->execSQL("delete from niveles where id=".$db->escape($oNivel->getId(),false,MYSQL_TYPE_INT));
			$db->commit();
