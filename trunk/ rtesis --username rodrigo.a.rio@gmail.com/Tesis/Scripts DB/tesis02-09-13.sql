...
insert  into `diagnosticos`(`id`,`descripcion`) values (1,'kjnjknjk'),(2,NULL),(3,NULL),(4,'no mueve los brazos.'),(6,'asdsdaa'),(7,'una descripcion'),(8,'adasda'),(9,NULL);
...
insert  into `diagnosticos_scc`(`id`) values (1),(3),(4),(8),(9);
...
CREATE TABLE `objetivos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(500) DEFAULT NULL,
  `fechaCreacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'necesario para saber si sigue siendo editable o no',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

/*Data for the table `objetivos` */

insert  into `objetivos`(`id`,`descripcion`,`fechaCreacion`) values (1,'realizar operaciones basicas','2013-09-02 00:00:00'),(2,'reconocer un numero primo de entre 1 y 100','2013-09-02 00:00:00'),(3,'Concentrarse en clase y recordar una clase asldjaldkj saldkj asdlkj asdlkj asdlkja sdlkjsa dlaksjd laksjd laskjd alskdj asldk jasldkjasdl jas','2013-09-02 00:00:00'),(4,'Poder contener la orina sda jsldj asldkj asldkj asldkj asldkj asldkja sdlkjas dlkaj sdlkasj dlaksjd alskdj asldkj11','2013-09-02 00:00:00'),(5,'Poder expresar una idea en clase. balskjdja aoi alsk y akj ASlkjasd ksjd ka. laksjdlak sd jka slkjd ','2013-09-02 00:00:00'),(9,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut in ante placerat, fringilla nibh vitae, facilisis tortor. Cras ut neque nec massa cursus ornare a ut elit. Sed ipsum erat, egestas vel viverra et, tristique vitae tortor. Phasellus a fermentum est. Aliquam at sagittis tortor, ut sollicitudin odio. Donec euismod non nulla vitae dictum. Pellentesque tincidunt sem non adipiscing consectetur. In hac habitasse platea dictumst. Nam tristique vel nunc eu porttitor.','2013-09-02 00:00:00'),(10,'otro objetivo aprendizaje para numeros naturales','2013-09-02 00:00:00');
...
insert  into `objetivos_personalizados`(`id`,`seguimientos_personalizados_id`,`objetivo_personalizado_ejes_id`,`objetivo_relevancias_id`,`estimacion`,`activo`) values (3,7,5,1,'2014-01-01',1),(4,7,11,3,'2013-09-16',1),(5,7,10,3,'2016-10-01',0),(9,7,5,3,'2013-09-26',1);
...
insert  into `parametros_sistema`(`parametros_id`,`valor`) values (1,'SGPAPD'),(9,'1'),(13,'5'),(14,'matiasvelillamdq@gmail.com'),(16,'5'),(17,'2'),(18,'14');
...
insert  into `seguimiento_scc_x_objetivo_aprendizaje`(`objetivos_aprendizaje_id`,`seguimientos_scc_id`,`objetivo_relevancias_id`,`estimacion`,`activo`) values (1,2,1,'2014-01-01',1),(1,3,2,'2014-02-02',1),(1,4,1,'2014-02-03',1),(1,8,2,'2013-09-02',1),(1,9,1,'2013-09-13',1),(2,2,1,'2014-01-08',1),(2,9,3,'2014-01-08',1);
...
insert  into `seguimientos_scc`(`id`,`diagnosticos_scc_id`) values (2,1),(3,3),(4,4),(8,8),(9,9);
