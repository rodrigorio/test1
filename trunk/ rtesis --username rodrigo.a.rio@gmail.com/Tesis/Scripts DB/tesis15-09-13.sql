...
insert  into `diagnosticos`(`id`,`descripcion`) values (1,'kjnjknjk'),(2,NULL),(3,NULL),(4,'no mueve los brazos.'),(6,'asdsdaa'),(7,'una descripcion'),(8,'adasda'),(9,'este chico esta en primer ciclo y va a una escuela especial y bleblebleblebleble'),(10,NULL),(11,NULL);
...
CREATE TABLE `diagnosticos_personalizado` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_diagnosticos_personalizado_seguimiento_pers` FOREIGN KEY (`id`) REFERENCES `seguimientos_personalizados` (`diagnosticos_personalizado_id`) ON DELETE CASCADE,
...
insert  into `diagnosticos_personalizado`(`id`,`codigo`) values (6,'222'),(7,'un codigo'),(10,NULL),(11,NULL);
...
CREATE TABLE `diagnosticos_scc` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_diagnosticos_scc_seguimientos_scc` FOREIGN KEY (`id`) REFERENCES `seguimientos_scc` (`diagnosticos_scc_id`) ON DELETE CASCADE,
...
insert  into `objetivos_personalizados`(`id`,`seguimientos_personalizados_id`,`objetivo_personalizado_ejes_id`,`objetivo_relevancias_id`,`estimacion`,`activo`,`fechaCreacion`) values (4,7,11,3,'2013-09-16',1,'2013-09-20 00:00:00'),(9,7,5,3,'2013-09-11',1,'2012-09-20 00:00:00');
...
insert  into `seguimiento_scc_x_objetivo_aprendizaje`(`objetivos_aprendizaje_id`,`seguimientos_scc_id`,`objetivo_relevancias_id`,`estimacion`,`activo`,`fechaCreacion`) values (1,2,1,'2014-01-01',1,'2013-09-20 00:00:00'),(1,3,2,'2014-02-02',1,'2013-09-20 00:00:00'),(1,4,1,'2014-02-03',1,'2013-09-20 00:00:00'),(2,2,1,'2014-01-08',1,'2013-09-20 00:00:00');
...
insert  into `seguimiento_x_unidad`(`unidades_id`,`seguimientos_id`,`fechaHora`) values (1,6,'2013-04-23 20:08:47'),(1,7,'2013-06-01 20:46:23'),(1,10,'2013-09-09 23:53:00'),(1,11,'2013-09-09 23:55:26'),(5,7,'2013-09-15 23:38:42'),(6,7,'2013-09-15 17:16:15');
...
insert  into `seguimientos_personalizados`(`id`,`diagnosticos_personalizado_id`) values (6,6),(7,7),(10,10),(11,11);
