...
insert  into `areas`(`id`,`ciclos_id`,`descripcion`) values (1,1,'matematica');
...
insert  into `ciclos`(`id`,`niveles_id`,`descripcion`) values (1,1,'primer ciclo');
...
insert  into `diagnosticos_scc_x_ejes`(`diagnosticos_scc_id`,`ejes_id`,`estadoInicial`) values (1,2,'rrrs fsd6586786fdsfdf mmmm'),(1,4,'sabe hasta la j...uuu');
...
insert  into `ejes`(`id`,`descripcion`,`contenidos`,`areas_id`) values (2,'numeros naturales','leer y escribir numeros de 100 a 250.',1),(3,'numeros primos','saber cuales son los numeros primos',1),(4,'abecedario','saber el abecedario completo',1);
...
insert  into `objetivos`(`id`,`descripcion`) values (1,'realizar operaciones basicas');
...
insert  into `objetivos_aprendizaje`(`ejes_id`,`id`) values (2,1);
...
insert  into `seguimientos`(`id`,`discapacitados_id`,`frecuenciaEncuentros`,`diaHorario`,`practicas_id`,`usuarios_id`,`antecedentes`,`pronostico`,`fechaCreacion`,`estado`) values (1,122,'todos los dias','ads',2,61,NULL,NULL,'2013-01-08 19:28:56','activo'),(2,122,'todos los dias','asdsa',1,61,NULL,NULL,'2013-01-08 19:32:57','activo');
