...
insert  into `areas`(`id`,`ciclos_id`,`descripcion`) values (1,1,'matematica'),(2,1,'sociales'),(3,1,'Lengua');
...
insert  into `diagnosticos`(`id`,`descripcion`) values (1,'kjnjknjk'),(2,NULL),(3,NULL),(4,'no mueve los brazos.'),(6,'asdsdaa'),(7,'una descripcion'),(8,'adasda');
...
insert  into `diagnosticos_personalizado`(`id`,`codigo`) values (6,'222'),(7,'un codigo');
...
insert  into `diagnosticos_scc`(`id`) values (1),(3),(4),(8);
...
insert  into `diagnosticos_scc_x_ejes`(`diagnosticos_scc_id`,`ejes_id`,`estadoInicial`) values (1,3,'788989'),(4,3,'cuenta los primos '),(8,2,'̱kjlj̱ljlkjhlkhkh 1'),(8,3,'sadasdasd adsa asd asd 1'),(8,4,'sdkaljs dlkasj dlajs dlakj ds 1'),(8,5,'asd adas dad !!!! sadjkal 1');
...
/*Table structure for table `entrevista_x_seguimiento` */

DROP TABLE IF EXISTS `entrevista_x_seguimiento`;

CREATE TABLE `entrevista_x_seguimiento` (
  `seguimientos_id` int(11) NOT NULL,
  `entrevistas_id` int(11) NOT NULL,
  PRIMARY KEY (`seguimientos_id`,`entrevistas_id`),
  KEY `FK_entrevista_x_seguimiento_relacion2` (`entrevistas_id`),
  CONSTRAINT `FK_entrevista_x_seguimiento_relacion` FOREIGN KEY (`seguimientos_id`) REFERENCES `seguimientos` (`id`),
  CONSTRAINT `FK_entrevista_x_seguimiento_relacion2` FOREIGN KEY (`entrevistas_id`) REFERENCES `entrevistas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `entrevista_x_seguimiento` */
...
insert  into `objetivo_personalizado_ejes`(`id`,`descripcion`,`ejePadre`) values (1,'Fisico',0),(2,'Fisiologico',1),(3,'Psicologico',0),(4,'Social',0),(5,'Atencion',3),(6,'Percepcion',3),(7,'Aprendizaje',3),(8,'Memoria',3),(9,'Pensamiento',3),(10,'Lenguaje',3),(11,'Motivacion',3),(12,'Emocion',3),(13,'Motriz',1),(14,'Asociacion',4),(15,'Aceptacion',4),(16,'Participacion',4),(17,'Seguridad',4),(18,'Estima',4);
...
insert  into `objetivos`(`id`,`descripcion`) values (1,'realizar operaciones basicas'),(2,'reconocer un numero primo de entre 1 y 100'),(3,'Concentrarse en clase y recordar una clase asldjaldkj saldkj asdlkj asdlkj asdlkja sdlkjsa dlaksjd laksjd laskjd alskdj asldk jasldkjasdl jas'),(4,'Poder contener la orina sda jsldj asldkj asldkj asldkj asldkj asldkja sdlkjas dlkaj sdlkasj dlaksjd alskdj asldkj'),(5,'Poder expresar una idea en clase. balskjdja aoi alsk y akj ASlkjasd ksjd ka. laksjdlak sd jka slkjd ');
...
insert  into `objetivos_aprendizaje`(`ejes_id`,`id`) values (2,1),(3,2);
...
insert  into `objetivos_personalizados`(`id`,`seguimientos_personalizados_id`,`objetivo_personalizado_ejes_id`,`objetivo_relevancias_id`,`estimacion`,`activo`) values (3,7,5,1,'2014-01-01',1),(4,7,2,2,'2013-01-15',1),(5,7,10,3,'2016-10-01',0);
...
CREATE TABLE `pregunta_x_opcion_x_seguimiento` (
  ...
  KEY `FK_pregunta_x_opcion_x_seguimiento` (`seguimientos_id`),
  CONSTRAINT `FK_pregunta_x_opcion_x_seguimiento` FOREIGN KEY (`seguimientos_id`) REFERENCES `seguimientos` (`id`),
  CONSTRAINT `FK_pregunta_x_opcion_x_seguimiento_opciones` FOREIGN KEY (`preguntas_id`) REFERENCES `preguntas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `preguntas_simples_respuestas` (
  ...
  KEY `FK_preguntas_simples_respuestas` (`seguimientos_id`),
  CONSTRAINT `FK_preguntas_simples_respuestas` FOREIGN KEY (`seguimientos_id`) REFERENCES `seguimientos` (`id`),
  CONSTRAINT `FK_preguntas_simples_respuestas preguntas` FOREIGN KEY (`preguntas_id`) REFERENCES `preguntas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `seguimiento_scc_x_objetivo_aprendizaje`(`objetivos_aprendizaje_id`,`seguimientos_scc_id`,`objetivo_relevancias_id`,`estimacion`,`activo`) values (1,2,1,'2014-01-01',1),(1,3,2,'2014-02-02',1),(1,4,1,'2014-02-03',1),(1,8,2,'2013-09-02',1),(2,2,1,'2014-01-08',1);
...
insert  into `seguimiento_x_unidad`(`unidad_id`,`seguimiento_id`,`fechaHora`) values (1,6,'2013-04-23 20:08:47'),(1,7,'2013-06-01 20:46:23');
...
insert  into `seguimientos`(`id`,`discapacitados_id`,`frecuenciaEncuentros`,`diaHorario`,`practicas_id`,`usuarios_id`,`antecedentes`,`pronostico`,`fechaCreacion`,`estado`) values (2,122,'todos los dias','asdsa',1,61,'AAAAaaaaAAa AAAa aaaaa...',NULL,'2013-01-08 19:32:57','activo'),(3,126,'3 dias','l m v 12 hs',2,61,NULL,NULL,'2013-04-23 19:16:03','activo'),(4,127,'1 vez por mes','1er lunes de cada mes',2,61,NULL,NULL,'2013-04-23 19:48:26','activo'),(6,127,'nunca','domingos 7 am',1,61,NULL,NULL,'2013-04-23 20:08:46','activo'),(7,128,'3 veces por semana','12hs',2,63,'hdaksdh askjd aksdh aksdh aksdh askjdh askdh aan\nasdlkajdklasjd\nasdasjdlajsldjasldjasldj',NULL,'2013-06-01 20:46:22','activo'),(8,128,'das dasd as','a dsa da s',3,63,'lkajdlaksjd alskdj \nasdlkjasdlkjasdlasjd \nasdlkaj dlaskjd \n\n',NULL,'2013-08-21 21:49:14','activo');
...
CREATE TABLE `seguimientos_personalizados` (
  ...
  CONSTRAINT `FK_seguimientos_personalizados_diagnostico_personalizado` FOREIGN KEY (`diagnosticos_personalizado_id`) REFERENCES `diagnosticos_personalizado` (`id`),
...
insert  into `seguimientos_personalizados`(`id`,`diagnosticos_personalizado_id`) values (6,6),(7,7);
...
insert  into `seguimientos_scc`(`id`,`diagnosticos_scc_id`) values (2,1),(3,3),(4,4),(8,8);
...
insert  into `unidades`(`id`,`usuarios_id`,`nombre`,`descripcion`,`preCargada`,`fechaHora`,`asociacionAutomatica`,`borradoLogico`,`tipoEdicion`) values (1,NULL,'unidad por defecto','Variables de texto asignadas al seguimiento al crearse.',0,NULL,1,0,'regular'),(5,63,'Una nueva Unidad','esta es la primera unidad de variables de prueba en el sistema',0,'2013-04-07 04:39:43',0,0,'regular'),(6,63,'haciendo una prueba','aldkjasldkj asdl jasldkj askdja s\ndasldj alsdkjasldj aldsj asldj ',0,'2013-04-07 07:25:21',0,0,'regular'),(7,63,'adsasd','adasdasdasdasd\nasdasd',0,'2013-08-27 22:47:46',0,0,'regular'),(8,63,'ssss','ssss',0,'2013-08-27 22:48:05',0,0,'esporadica');
...
insert  into `variables`(`id`,`nombre`,`tipo`,`descripcion`,`unidad_id`,`fechaHora`,`borradoLogico`) values (1,'Texto descripcion','VariableTexto',NULL,1,NULL,0),(3,'Una prueba','VariableTexto','asdas\r\ndasd\r\nasd\r\nasdasdasdas',6,'2013-04-07 07:26:19',0),(4,'adsfadsf 1234','VariableNumerica','adfsadsfads 1234',5,'2013-04-07 07:26:58',0),(6,'una nueva variable de texto1','VariableTexto','asdlkasjdlas\nasldjasldjasldjlakdjalsdjalsdj\nasldjasldkjaskld\n\nalskdjalsdjalskdjlaskjdlaskd1',5,'2013-04-11 02:42:03',0),(7,'nueva variable ','VariableTexto','adsfkladsjf lakdsj fadsf\ndasflj adslfkj adsf\nadlfkj adslfjadlskjf \ndalfkj adslfk aldskjf ads\n',5,'2013-04-11 03:03:27',0),(8,'nueva variable numerica','VariableNumerica','sdfads',5,'2013-04-11 03:08:08',0),(35,'TEST PIPIPI Fotografia 1','VariableCualitativa','colores que ve cuando se le muestra la figura blebleble',5,'2013-05-04 21:22:43',0);
