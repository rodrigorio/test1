...
insert  into `parametros_sistema`(`parametros_id`,`valor`) values (1,'SGPAPD'),(9,'1'),(13,'5'),(14,'matiasvelillamdq@gmail.com'),(16,'5');
...
insert  into `usuario_x_invitado`(`usuarios_id`,`invitados_id`,`relacion`,`fecha`,`estado`,`token`,`nombre`,`apellido`) values (63,117,'asdfadsfjdsfads\nfdsf\nasdf\ndsf','2012-09-15 08:22:10','pendiente','7dde8ba57614529a7b679a4d3b876f55','Evangelina','Monello'),(63,118,'sadfsadf\ndasfalsdkfjaksldfjal','2012-09-15 08:38:52','pendiente','dfb59af3275910cd55683cdecdd7b237','Eduardo','Velilla');
