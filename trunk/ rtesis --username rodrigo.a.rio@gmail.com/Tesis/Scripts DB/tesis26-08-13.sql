...
CREATE TABLE `objetivo_personalizado_ejes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(50) NOT NULL,
  `eje_padre` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1;

/*Data for the table `objetivo_personalizado_ejes` */

insert  into `objetivo_personalizado_ejes`(`id`,`descripcion`,`eje_padre`) values (1,'Fisico',0),(2,'Fisiologico',1),(3,'Psicologico',0),(4,'Social',0),(5,'Atencion',3),(6,'Percepcion',3),(7,'Aprendizaje',3),(8,'Memoria',3),(9,'Pensamiento',3),(10,'Lenguaje',3),(11,'Motivacion',3),(12,'Emocion',3),(13,'Motriz',1),(14,'Asociacion',4),(15,'Aceptacion',4),(16,'Participacion',4),(17,'Seguridad',4),(18,'Estima',4);

/*Table structure for table `objetivo_personalizado_evolucion` */

DROP TABLE IF EXISTS `objetivo_personalizado_evolucion`;

CREATE TABLE `objetivo_personalizado_evolucion` (
  `id` int(11) NOT NULL,
  `objetivos_personalizados_id` int(11) NOT NULL,
  `evolucion` double NOT NULL,
  `comentarios` text,
...
/*Data for the table `objetivo_personalizado_evolucion` */
...
insert  into `objetivo_relevancias`(`id`,`descripcion`) values (1,'baja'),(2,'media'),(3,'alta');
...
insert  into `objetivos`(`id`,`descripcion`) values (1,'realizar operaciones basicas'),(2,'reconocer un numero primo de entre 1 y 100');
...
insert  into `unidades`(`id`,`usuarios_id`,`nombre`,`descripcion`,`preCargada`,`fechaHora`,`asociacionAutomatica`,`borradoLogico`) values (1,NULL,'unidad por defecto','Variables de texto asignadas al seguimiento al crearse.',0,NULL,1,0),(5,63,'Una nueva Unidad','esta es la primera unidad de variables de prueba en el sistema',0,'2013-04-07 04:39:43',0,0),(6,63,'haciendo una prueba','aldkjasldkj asdl jasldkj askdja s\ndasldj alsdkjasldj aldsj asldj ',0,'2013-04-07 07:25:21',0,0);
