...
insert  into `areas`(`id`,`anios_id`,`descripcion`) values (6,3,'Matemática'),(7,2,'Matemática'),(8,4,'Matemática'),(9,5,'Pácticas del lenguaje');
