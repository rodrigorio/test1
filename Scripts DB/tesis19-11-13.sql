...
insert  into `anios`(`id`,`ciclos_id`,`descripcion`) values (2,1,'Segundo Año');
...
insert  into `areas`(`id`,`anios_id`,`descripcion`) values (5,2,'probando 12345');
...
insert  into `ejes`(`id`,`descripcion`,`areas_id`) values (21,'dfgf hdh dgfhdgh gh d',5);
...
insert  into `objetivos_aprendizaje`(`ejes_id`,`id`) values (21,47);
