...
insert  into `diagnosticos_scc_x_ejes`(`diagnosticos_scc_id`,`ejes_id`,`estadoInicial`) values (1,2,'1232131232'),(1,3,'cuentan todos los numeros.');
...
insert  into `unidades`(`id`,`usuarios_id`,`nombre`,`descripcion`,`preCargada`,`fechaHora`,`asociacionAutomatica`) values (1,NULL,'unidad por defecto','Variables de texto asignadas al seguimiento al crearse.',0,NULL,1);
...
insert  into `variables`(`id`,`nombre`,`tipo`,`descripcion`,`unidad_id`,`fechaHora`) values (1,'Texto descripcion','VariableTexto',NULL,1,NULL);
