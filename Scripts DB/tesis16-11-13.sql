...
insert  into `ejes`(`id`,`descripcion`,`areas_id`) values (2,'Números naturales',1),(3,'Números primos',1),(4,'Abecedario',3),(5,'Historia Argentina 1',2);
...
insert  into `objetivo_evolucion`(`id`,`entradas_id`,`objetivos_personalizados_id`,`seg_scc_x_obj_apr_obj_id`,`seg_scc_x_obj_apr_seg_id`,`progreso`,`comentarios`) values (23,40,12,NULL,NULL,50,'asdfadsf'),(25,57,12,NULL,NULL,77,'sdfasfasdf');
