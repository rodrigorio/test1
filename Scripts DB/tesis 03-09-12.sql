...
insert  into `parametro_x_usuario`(`parametros_id`,`usuarios_id`,`valor`) values (4,63,'0');
...
insert  into `parametros`(`id`,`descripcion`,`tipo`,`namespace`) values (1,'para usar en metatags, firmas de mail, etc','string','NOMBRE_SITIO'),(3,'cantidad de fichas o elementos en los distintos listados del sitio','numeric','CANTIDAD_LISTADO'),(4,'activar o desactivar notificaciones por mail (sistema/controlador/usuario, etc)','boolean','NOTIFICACIONES_MAIL'),(5,'metatag description para el header de las vistas del sistema.','string','METATAG_DESCRIPTION'),(6,'kjhjkhhk ','string','uno_de_prueba2');
...
insert  into `parametros_sistema`(`parametros_id`,`valor`) values (1,'SGPAPD');
