...
insert  into `publicaciones`(`id`,`usuarios_id`,`moderado`,`publico`,`activoComentarios`,`descripcionBreve`,`keywords`) values (1,63,0,0,1,'esta es una descripcion tan breve no ?','uno dos tres cuatro cinco cinco seis'),(2,63,0,1,0,'asdfadsfadsfadfs','sdf adsf adsf adsf ');
