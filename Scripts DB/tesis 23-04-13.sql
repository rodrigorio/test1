...
insert  into `diagnosticos`(`id`,`descripcion`) values (1,'kjnjknjk'),(2,NULL),(3,NULL);
...
insert  into `diagnosticos_scc`(`id`) values (1),(3);
...
insert  into `diagnosticos_scc_x_ejes`(`diagnosticos_scc_id`,`ejes_id`,`estadoInicial`) values (1,3,'788989');
...
insert  into `seguimientos`(`id`,`discapacitados_id`,`frecuenciaEncuentros`,`diaHorario`,`practicas_id`,`usuarios_id`,`antecedentes`,`pronostico`,`fechaCreacion`,`estado`) values (2,122,'todos los dias','asdsa',1,61,'AAAAaaaaAAa AAAa aaaaa...',NULL,'2013-01-08 19:32:57','activo'),(3,126,'3 dias','l m v 12 hs',2,61,NULL,NULL,'2013-04-23 19:16:03','activo');
...
insert  into `seguimientos_scc`(`id`,`diagnosticos_scc_id`) values (2,1),(3,1);
...
insert  into `variable_cualitativa_modalidades`(`id`,`variables_id`,`modalidad`,`orden`,`borradoLogico`) values (1,5,'malo',1,0),(2,5,'regular',1,0);
